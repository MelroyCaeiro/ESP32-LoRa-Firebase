...
#define WIFI_SSID "Gilroy'sWifi@unifi"
#define WIFI_PASSWORD "matilda25"
...
void loop()
{
	...
	json.set("/Sensor1", recv_payload1);
...
//	Serial.println("");
	...
	if (BufferSize > 0)
	{
     ...
     recv_payload1 = RcvBuffer[1];
     recv_payload2 = RcvBuffer[2];
     recv_payload3 = RcvBuffer[3];
     recv_payload4 = RcvBuffer[4];
